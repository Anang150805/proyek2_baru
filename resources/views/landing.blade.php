...
<body class="bg-purple-900 text-white">
    ...
    <section class="mt-16 p-10 bg-purple-800">
    <h2 class="text-3xl font-bold text-center" data-aos="flip-up">Apa Kata Mereka? ❤️</h2>
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto mt-6">
        <div class="bg-white text-purple-900 p-6 rounded-lg shadow-lg" data-aos="fade-right">
            <p>“MPASI Baby Gemez sangat praktis! Anak saya suka sekali dan selalu habis.”</p>
            <p class="mt-2 font-bold">- Ibu Latifah</p>
        </div>
        <div class="bg-white text-purple-900 p-6 rounded-lg shadow-lg" data-aos="fade-up">
            <p>“Pilihan menu MPASI sangat bervariasi, cocok untuk anak saya yang suka pilih-pilih makanan.”</p>
            <p class="mt-2 font-bold">- Bapak Anang</p>
        </div>
        <div class="bg-white text-purple-900 p-6 rounded-lg shadow-lg" data-aos="fade-left">
            <p>“Rasanya enak dan kualitasnya terjaga! Anak saya selalu menunggu waktu makan.”</p>
            <p class="mt-2 font-bold">- Bapak indra</p>
        </div>
    </div>
</section>
